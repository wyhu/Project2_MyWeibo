...
@property (nonatomic, copy) NSNumber *favorited;//favorited	boolean	是否已收藏，true：是，false：否
@property (nonatomic ,copy) NSNumber *truncated;//truncated	boolean	是否被截断，true：是，false：否
@property (nonatomic,copy) NSString *mid;//微博MID
...
@property (nonatomic,copy) NSNumber *mlevel;
//mlevel	int	暂未支持
